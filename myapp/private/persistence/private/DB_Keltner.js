...
module.exports = {
    ...
    getLastKeltners: function (callback, pairList, currencyList, AutonomousTrigger, ActiveTriggersKeltner,  LastBalance, OpenOrders) {
        new Promise(function (resolve, reject) {
            ...
            callback(null, data, pairList, currencyList, AutonomousTrigger, ActiveTriggersKeltner,  LastBalance, OpenOrders);
        }).catch(function(err) {
            callback(err, null, pairList, currencyList, AutonomousTrigger, ActiveTriggersKeltner,  LastBalance, OpenOrders);
        });
    },
