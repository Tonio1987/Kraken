...
home('Returns time continuously', () => new Promise(
  (resolve, reject) => {
...
home('Callback agrees with object', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(120000)
    const limiter = loadLimiter(defaults)
    const call = loadCall(defaults, limiter)
...
home('Returns instance', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(120000)
    const limiter = loadLimiter(defaults)
    const call = loadCall(defaults, limiter)
...
home('Stops when closed', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(120000)
    const limiter = loadLimiter(defaults)
    const call = loadCall(defaults, limiter)
...
home('Resumes operation after close', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(120000)
    const limiter = loadLimiter(defaults)
    const call = loadCall(defaults, limiter)
...
home('Custom intervals work', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(120000)
    const limiter = loadLimiter(defaults)
    const call = loadCall(defaults, limiter)
...
home('Custom interaction with instance works', () => new Promise(
  (resolve, reject) => {
...
home('Custom data formatting works', () => new Promise(
  (resolve, reject) => {
    jest.setTimeout(60000)
