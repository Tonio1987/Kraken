...
home('Is function', () => expect(kraken.constructor).toBe(Function))
...
home('Retrieves parsed time from Kraken servers', () => new Promise(
  (resolve, reject) => {
...
home('Observes rate limits', () => new Promise(
  resolve => {
...
home('Realtime settings work', () => new Promise(
  resolve => {
    jest.setTimeout(60000)
    const api = kraken()
