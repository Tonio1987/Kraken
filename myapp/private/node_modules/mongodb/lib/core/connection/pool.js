...
const MongoTimeoutError = require('mongodb/lib/core/error').MongoTimeoutError;
...
const Msg = require('mongodb/lib/core/connection/msg').Msg;
const CommandResult = require('mongodb/lib/core/connection/command_result');
const MESSAGE_HEADER_SIZE = require('mongodb/lib/core/wireprotocol/shared').MESSAGE_HEADER_SIZE;
const COMPRESSION_DETAILS_SIZE = require('mongodb/lib/core/wireprotocol/shared').COMPRESSION_DETAILS_SIZE;
const opcodes = require('mongodb/lib/core/wireprotocol/shared').opcodes;
const compress = require('mongodb/lib/core/wireprotocol/compression').compress;
const compressorIDs = require('mongodb/lib/core/wireprotocol/compression').compressorIDs;
const uncompressibleCommands = require('mongodb/lib/core/wireprotocol/compression').uncompressibleCommands;
const apm = require('mongodb/lib/core/connection/apm');
const Buffer = require('safe-buffer/index').Buffer;
const connect = require('mongodb/lib/core/connection/connect');
const updateSessionFromResponse = require('mongodb/lib/core/sessions').updateSessionFromResponse;
const eachAsync = require('mongodb/lib/core/utils').eachAsync;
