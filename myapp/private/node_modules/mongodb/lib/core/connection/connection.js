...
const parseHeader = require('mongodb/lib/core/wireprotocol/shared').parseHeader;
const decompress = require('mongodb/lib/core/wireprotocol/compression').decompress;
const Response = require('mongodb/lib/core/connection/commands').Response;
const BinMsg = require('mongodb/lib/core/connection/msg').BinMsg;
...
const OP_COMPRESSED = require('mongodb/lib/core/wireprotocol/shared').opcodes.OP_COMPRESSED;
const OP_MSG = require('mongodb/lib/core/wireprotocol/shared').opcodes.OP_MSG;
